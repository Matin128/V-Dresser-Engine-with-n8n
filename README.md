# ⚡ سیستم هوشمند پرو مجازی لباس (AI Virtual Try-On) برای ووکامرس و فروشگاه‌های آنلاین

🚀 **یک فلو آنلاین در n8n برای پرو اختصاصی لباس روی مدل انسانی با استفاده از هوش مصنوعی، مدیریت وضعیت (State Management) با Redis و پیام‌رسان تلگرام**
...
![دموی فرآیند پرو مجازی](demo.gif)
